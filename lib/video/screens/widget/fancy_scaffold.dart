...
class FancyScaffold extends StatefulWidget {
  ...
  const FancyScaffold({
    ...
    this.internalKey,
    required this.floatingWidgetConfig,
...
class _FancyScaffoldState extends State<FancyScaffold>
  ...
  final VelocityTracker _vt = VelocityTracker.withKind(
  ...
  void initState() {
    ...
    _navigationBarAnimationController.animateTo(
      1,
      duration: Duration.zero,
    );

    // Floating widget animation controller
    _floatingWidgetAnimationController = AnimationController(
      vsync: this,
    ...
    _floatingWidgetScrollController = ScrollController();
    _floatingWidgetScrollController.addListener(() {
      if (!_scrollingEnabled) _floatingWidgetScrollController.jumpTo(0);
    });
  }

  @override
  Widget build(BuildContext context) {
    if (widget.floatingWidgetController != null) {
              ...
              children: [
                        ...
                        appBar: widget.appBar != null
                            ? PreferredSize(
                                preferredSize: Size(
                                    double.infinity,
                                    kToolbarHeight *
                                        _navigationBarAnimationController
                                            .value),
                                child: Container(
                                  color: Theme.of(context).cardColor,
                                  child: Opacity(
                                      opacity: (_navigationBarAnimationController
                                                      .value -
                                                  (1 -
                                                      _navigationBarAnimationController
                                                          .value)) >
                ...
                Container(
                    height: (MediaQuery.of(context).padding.bottom *
                            (widget.floatingWidgetTwins != null
                                ? (1 - _floatingWidgetAnimationController.value)
                                : 1)) *
                        (1 - _floatingWidgetAnimationController.value),
                    color: Theme.of(context).cardColor)
          ...
          child: Listener(
            ...
            child: NotificationListener<ScrollUpdateNotification>(
              onNotification: (ScrollUpdateNotification details) {
                pixelsScrolled = (pixelsScrolled + details.scrollDelta!.abs())
                        .clamp(0, 100) /
                    100;
  ...
  Widget _actualSlidingPanel() {
    return !widget.floatingWidgetConfig.isPanelVisible ||
            widget.floatingWidgetTwins == null
        ? Container()
        : _gestureHandler(
              ...
              builder: (context, child) {
                return Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        borderRadius:
                            _floatingWidgetAnimationController.value == 1
                                ? BorderRadius.zero
                      ...
                      return ClipRRect(
                        ...
                        child: SizedBox(
                            height: (widget.floatingWidgetConfig.maxHeight *
                                ...
                                (widget.floatingWidgetConfig.minHeight *
                                    (1 -
                                        _floatingWidgetAnimationController
                                            .value)),
              ...
              if (widget.floatingWidgetConfig.backdropBlurStrength != 0) {
                return BackdropFilter(
                  ...
                  child: Container(
                    ...
                    color: _floatingWidgetAnimationController.value == 0.0
                        ? null
  ...
  void _onGestureEnd(Velocity v) {
    ...
    double d2Snap = (3 - _floatingWidgetAnimationController.value)
  ...
  Future<void> _animatePanelToPosition(
    ...
    return _floatingWidgetAnimationController.animateTo(
      value,
      duration: duration,
      curve: curve,
    );
...
class FloatingWidgetController {
  ...
  Future<void> animatePanelToPosition(
    ...
    assert(isAttached, "PanelController must be attached to a SlidingUpPanel");
    assert(0.0 <= value && value <= 1.0);
    return _scaffoldState!._animatePanelToPosition(
      value,
      duration: duration,
      curve: curve,
    );
